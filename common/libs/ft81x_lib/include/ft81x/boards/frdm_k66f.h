...
#define FT81X_BOARD_DISPLAY_DCX_PIN_PORT    PTB
#define FT81X_BOARD_DISPLAY_DCX_PIN_NUM     19

#define FT81X_BOARD_DISPLAY_DISP_PIN_PORT   PTC
#define FT81X_BOARD_DISPLAY_DISP_PIN_NUM    16
